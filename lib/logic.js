...
/**
 * Sample transaction
 * @param {org.blockwiz.voting.vote} vote
 * @transaction
 */
function vote(tx) {
    /*
    ...
    const assetRegistry = await getAssetRegistry('org.blockwiz.voting.SampleAsset');
    // Update the asset in the asset registry.
    await assetRegistry.update(tx.asset);

    // Emit an event for the modified asset.
    let event = getFactory().newEvent('org.blockwiz.voting', 'SampleEvent');
